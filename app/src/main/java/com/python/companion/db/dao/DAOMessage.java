...
public abstract class DAOMessage {
    ...
    /** Returns a notification for a specific anniversary (using anniversaryID), where notification is scheduled on given date */
    @Query("SELECT * FROM Message WHERE anniversaryID = :anniversaryID AND messageDate = :messageDate")
