...
public class JubileumCalculatorActivity extends AppCompatActivity {
    ...
    private void prepareList() {
        ...
        sortHandler = new JubileumCalculatorSortHandler.Builder()
                .setStrategy(getSharedPreferences(getString(R.string.cactus_preferences), Context.MODE_PRIVATE).getInt("CactusJubileumSort", JubileumCalculatorSortHandler.SORT_DURATION))
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        @IdRes int id;
        switch (getSharedPreferences(getString(R.string.cactus_preferences), Context.MODE_PRIVATE).getInt("CactusJubileumSort", JubileumCalculatorSortHandler.SORT_DURATION)) {
