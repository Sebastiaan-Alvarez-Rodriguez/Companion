package com.python.companion.ui.jubileum.activity.calculate;
...
import com.python.companion.ui.jubileum.adapter.JubileumCalculatorSortHandler;
...
public class JubileumCalculatorSharedActivity extends AppCompatActivity {
    ...
    private ItemAdapter<JubileumCalculatorItem> itemAdapter;
    private FastAdapter<JubileumCalculatorItem> fastAdapter;
    private JubileumCalculatorSortHandler sortHandler;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jubileum_calculator);
    ...
    private void prepareButtons() {
        displayGroup.setOnCheckedChangeListener((group, checkedId) -> {
            ...
            for (JubileumCalculatorItem x : itemAdapter.getAdapterItems())
                x.onTypeChange(t);
    ...
    private void prepareList() {
        ComparableItemListImpl<JubileumCalculatorItem> itemList = new ComparableItemListImpl<>((o1, o2) -> 0);
        itemAdapter = new ItemAdapter<>(itemList);
        fastAdapter = FastAdapter.with(itemAdapter);

        sortHandler = new JubileumCalculatorSortHandler.Builder()
                .setStrategy(getSharedPreferences(getString(R.string.cactus_preferences), Context.MODE_PRIVATE).getInt("CactusCalculatorSort", JubileumCalculatorSortHandler.SORT_DURATION))
    ...
    private void setListUpdates() {
        ...
        viewModel.getMeasurements().observe(this, measurements -> {
            ...
            FastAdapterDiffUtil.INSTANCE.set(itemAdapter, list, new DiffCallback<JubileumCalculatorItem>() {
                ...
                @Override
                public boolean areContentsTheSame(JubileumCalculatorItem oldItem, JubileumCalculatorItem newItem) {
                ...
                @Nullable
                @Override
                public Object getChangePayload(JubileumCalculatorItem oldItem, int oldPosition, JubileumCalculatorItem newItem, int newPosition) {
    ...
    private void setListFiltering() {
        ...
        itemAdapter.getItemFilter().setItemFilterListener(new ItemFilterListener<JubileumCalculatorItem>() {
            @Override
            public void itemsFiltered(@Nullable CharSequence charSequence, @Nullable List<? extends JubileumCalculatorItem> list) {
            }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        @IdRes int id;
        switch (getSharedPreferences(getString(R.string.cactus_preferences), Context.MODE_PRIVATE).getInt("CactusCalculatorSort", JubileumCalculatorSortHandler.SORT_DURATION)) {
            case JubileumCalculatorSortHandler.SORT_ALPHA:
                id = R.id.activity_cactus_jubileum_sort_alpha;
                break;
            case JubileumCalculatorSortHandler.SORT_DURATION:
            default:
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        @JubileumCalculatorSortHandler.CactusSortStrategy int strategy;
        switch (item.getItemId()) {
            case android.R.id.home:
                finish();
                return super.onOptionsItemSelected(item);
            case R.id.activity_cactus_jubileum_sort_alpha:
                strategy = JubileumCalculatorSortHandler.SORT_ALPHA;
                break;
            case R.id.activity_cactus_jubileum_sort_duration:
                strategy = JubileumCalculatorSortHandler.SORT_DURATION;
                break;
            default:
                return super.onOptionsItemSelected(item);
        }
